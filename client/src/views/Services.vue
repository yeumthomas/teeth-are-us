<template>
    <div>
            ...
            <section class="section-shaped my-0">
                ...
                <div class="lg-only-padding-top shape-container align-self-center mt--200 pt-5 make-that-gap-even-smaller">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-7 mt-3 text-center mb-5 align-items-center" style="width: 70%">
        ...
        <section class="section section-lg pb-0 pt-lg-0 mt--300 make-that-gap-even-smaller">
            <div class="mx-3">
				<div class="row mb-5">
                    ...
                    <div class="col-md-12 col-lg-4 mb-4">
						<div class="card border-0 shadow-lg h-100">
							<div class="service-card-photo">
								<a href="service-page.html"><img src="https://www.katyolivedental.com/static/img/services/cosmetic_370x320.jpg" class="img-fluid card-img-top" alt=""></a>
							</div>
                            <div class="row m-3">
					...
					<div class="col-md-12 col-lg-4 mb-4">
						<div class="card border-0 shadow-lg h-100">
							<div class="service-card-photo">
								<a href="service-page.html"><img src="https://www.katyolivedental.com/static/img/services/children_370x320.jpg" class="img-fluid card-img-top" alt=""></a>
							</div>
                            <div class="row m-3">
        ...
        <section class="section section-md pb-0 mb-0 mt--100">
            <div class="row">
                <div class="col-12 px-lg-5 px-2 py-5 bg-secondary">
                    ...
                    <div class="row text-primary">
                        ...
                        <div class="px-4 col-sm-5">
                            <h6><icon class="fa fa-check"></icon><b>Aetna</b></h6>
                            <h6><icon class="fa fa-check"></icon><b>Humana</b></h6>
                            <h6><icon class="fa fa-check"></icon><b>BCBS of Texas</b></h6>
                            <h6><icon class="fa fa-check"></icon><b>Metlife</b></h6>
                            <h6><icon class="fa fa-check"></icon><b>Cigna</b></h6>
                            <h6><icon class="fa fa-check"></icon><b>United Healthcare</b></h6>
                            
                        </div>
                        <div class="px-4 col-sm-5">
                            <h6><icon class="fa fa-check"></icon><b>Delta Dental</b></h6>
                            <h6><icon class="fa fa-check"></icon><b>MCNA Dental</b></h6>
                            <h6><icon class="fa fa-check"></icon><b>Guardian</b></h6>
                            <h6><icon class="fa fa-check"></icon><b>TMHP Texas Medicaid</b></h6>
                            <h6><icon class="fa fa-check"></icon><b>Dentaquest</b></h6>
                        </div>
